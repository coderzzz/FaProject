...
- (BOOL)prepareMessageAudioModel:(id<IMessageModel>)messageModel
                      updateViewCompletion:(void (^)(id prevAudioModel, id currentAudioModel))updateCompletion
{
    BOOL isPrepare = NO;
    
    if(messageModel.bodyType == EMMessageBodyTypeVoice)
    {
        id<IMessageModel> prevAudioModel = self.audioMessageModel;
        id<IMessageModel> currentAudioModel = messageModel;
...
- (id<IMessageModel>)stopMessageAudioModel
{
