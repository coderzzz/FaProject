...
{
    if (!_underLine) {
        UIView *underLine = [[UIView alloc] initWithFrame:CGRectMake(15, self.height-4, 60 + 5, 2)];
...
- (void)setup
{
    UIButton *hotBtn = [self createBtn:@"动态" tag:HomeTypeHot];
    UIButton *newBtn = [self createBtn:@"私信" tag:HomeTypeNew];
