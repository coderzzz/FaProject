...
- (id)messageViewController:(EaseMessageViewController *)viewController
                  progressDelegateForMessageBodyType:(id)messageBodyType;
 ...
 */
- (BOOL)messageViewController:(EaseMessageViewController *)viewController
shouldSendHasReadAckForMessage:(id)message
                         read:(BOOL)read;
...
@interface EaseMessageViewController : EaseRefreshTableViewController<UINavigationControllerDelegate, UIImagePickerControllerDelegate, EMCDDeviceManagerDelegate, EMChatToolbarDelegate, EaseChatBarMoreViewDelegate, EaseMessageCellDelegate>
...
//@property (strong, nonatomic) FabricSocket *socket;
...
/*!
 ...
 @result
 */
//- (void)addMessageToDataSource:(id)message
