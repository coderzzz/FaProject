...
@interface VideoContentViewController ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
//            
//            
//            [headerView setClick:^(NSString *url){
//                
//                
