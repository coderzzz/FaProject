...
@interface FabricVideoViewController ()<UISearchBarDelegate,UIScrollViewDelegate>
...
@implementation FabricVideoViewController
...
- (void)addAreaVCWithArray:(NSMutableArray *)ary{
    ...
    [areavc setClickArea:^(NSString *areaName){
        VideoContentViewController * vc = self.childViewControllers[index];
